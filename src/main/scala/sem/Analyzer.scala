...
//  op.next = opt.Ret(List(Data(Some(op), index)))
...
//  subOp.next = op
//  op.next = opt.Ret(List(Data(Some(op), 0)))
...
//  new BuiltinGlobalVar(module, name, ConstFun(new BuiltinFun(module, List(IntDatatype(false), IntDatatype(false)), IntDatatype(false),
...
//  new BuiltinGlobalVar(module, "*", ConstFun(new BuiltinFun(module, List(IntDatatype(false), IntDatatype(false)), IntDatatype(false),
...
//  new BuiltinGlobalVar(module, name, ConstFun(new BuiltinFun(module, List(IntDatatype(false), IntDatatype(false)), BoolDatatype(false),
...
//
//  new BuiltinGlobalVar(module, "println", ConstFun(new BuiltinFun(module, List(IntDatatype(false)), UnitDatatype(false),
//    None,
//    {
